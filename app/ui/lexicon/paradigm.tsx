...
function AdjectiveTable({ lemma }: { lemma: LemmaFull }) {
    return (
        <>
            <ParadigmTable condition={/^----p....$/} lemma={lemma} caption="Positive">
            ...
            <ParadigmTable condition={/^----s....$/} lemma={lemma} caption="Superlative">
                <thead className="pt-3">
                    <tr>
                        <ParadigmHead colSpan={2} rowSpan={2}/>
                        <ParadigmHead label="singular" colSpan={3}/>
...
function DeterminerTable({ lemma }: { lemma: LemmaFull }) {
    return (
        <>
            ...
            <ParadigmTable lemma={lemma} condition={/^-----xpx-$/} exclude={true}>
                <thead className="pt-3">
                    <tr>
                        <ParadigmHead rowSpan={2}/>
                        <ParadigmHead label="singular" colSpan={3}/>
...
function VerbTable({ lemma }: { lemma: LemmaFull}) {
    return (
        <>
            ...
            <ParadigmTable caption="Finite forms">
                <thead>
                    <tr>
                        <ParadigmHead colSpan={2} rowSpan={2}/>
            ...
            <ParadigmTable lemma={lemma} condition={/^r---p....$/} caption="Resultative positive">
                <thead>
                    <tr>
                        <ParadigmHead colSpan={2} rowSpan={2}/>
                        <ParadigmHead label="singular" colSpan={3}/>
